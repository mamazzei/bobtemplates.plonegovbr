    ...
    def test_addon_template(self):
        ...
        self.assertItemsEqual(
            ...
            [
                ...
                self.project + '/src/brasil/gov/addon/upgrades/v1010',
                self.project + '/src/brasil/gov/addon/upgrades/v1010/__init__.py',
                self.project + '/src/brasil/gov/addon/upgrades/v1010/configure.zcml',
...
class ContentTypeTemplateTest(BaseTemplateTest):
    ...
    project = 'brasil.gov.contenttype'
    ...
    def test_addon_template(self):
        ...
        self.assertItemsEqual(
            ...
            [
                ...
                self.project + '/src/brasil/gov',
                self.project + '/src/brasil/gov/__init__.py',
                self.project + '/src/brasil/gov/contenttype',
                self.project + '/src/brasil/gov/contenttype/__init__.py',
                self.project + '/src/brasil/gov/contenttype/browser',
                self.project + '/src/brasil/gov/contenttype/browser/__init__.py',
                self.project + '/src/brasil/gov/contenttype/browser/configure.zcml',
                self.project + '/src/brasil/gov/contenttype/browser/templates',
                self.project + '/src/brasil/gov/contenttype/browser/templates/helloworld.pt',
                self.project + '/src/brasil/gov/contenttype/browser/view.py',
                self.project + '/src/brasil/gov/contenttype/config.py',
                self.project + '/src/brasil/gov/contenttype/configure.zcml',
                self.project + '/src/brasil/gov/contenttype/content',
                self.project + '/src/brasil/gov/contenttype/content/__init__.py',
                self.project + '/src/brasil/gov/contenttype/content/example.py',
                self.project + '/src/brasil/gov/contenttype/content/schema',
                self.project + '/src/brasil/gov/contenttype/content/schema/__init__.py',
                self.project + '/src/brasil/gov/contenttype/content/schema/Example.xml',
                self.project + '/src/brasil/gov/contenttype/interfaces.py',
                self.project + '/src/brasil/gov/contenttype/profiles',
                self.project + '/src/brasil/gov/contenttype/profiles.zcml',
                self.project + '/src/brasil/gov/contenttype/profiles/default',
                self.project + '/src/brasil/gov/contenttype/profiles/default/browserlayer.xml',
                self.project + '/src/brasil/gov/contenttype/profiles/default/metadata.xml',
                self.project + '/src/brasil/gov/contenttype/profiles/default/rolemap.xml',
                self.project + '/src/brasil/gov/contenttype/profiles/default/types',
                self.project + '/src/brasil/gov/contenttype/profiles/default/types.xml',
                self.project + '/src/brasil/gov/contenttype/profiles/default/types/Example.xml',
                self.project + '/src/brasil/gov/contenttype/profiles/uninstall',
                self.project + '/src/brasil/gov/contenttype/profiles/uninstall/brasil.gov.contenttype.txt',  # noqa
                self.project + '/src/brasil/gov/contenttype/static',
                self.project + '/src/brasil/gov/contenttype/static/example_icon.png',
                self.project + '/src/brasil/gov/contenttype/testing.py',
                self.project + '/src/brasil/gov/contenttype/tests',
                self.project + '/src/brasil/gov/contenttype/tests/__init__.py',
                self.project + '/src/brasil/gov/contenttype/tests/test_content.py',
                self.project + '/src/brasil/gov/contenttype/tests/test_example.robot',
                self.project + '/src/brasil/gov/contenttype/tests/test_robot.py',
                self.project + '/src/brasil/gov/contenttype/tests/test_setup.py',
                self.project + '/src/brasil/gov/contenttype/upgrades',
                self.project + '/src/brasil/gov/contenttype/upgrades/__init__.py',
                self.project + '/src/brasil/gov/contenttype/upgrades/configure.zcml',
                self.project + '/src/brasil/gov/contenttype/upgrades/v1010',
                self.project + '/src/brasil/gov/contenttype/upgrades/v1010/__init__.py',
                self.project + '/src/brasil/gov/contenttype/upgrades/v1010/configure.zcml',
    ...
    def test_tema_template(self):
        ...
        self.assertItemsEqual(
            ...
            [
                ...
                self.project + '/src/brasil/gov/tema/browser',
                self.project + '/src/brasil/gov/tema/browser/__init__.py',
                self.project + '/src/brasil/gov/tema/browser/configure.zcml',
                self.project + '/src/brasil/gov/tema/browser/viewlets',
                self.project + '/src/brasil/gov/tema/browser/viewlets/__init__.py',
                self.project + '/src/brasil/gov/tema/browser/viewlets/configure.zcml',
                self.project + '/src/brasil/gov/tema/browser/viewlets/path_bar.py',
                self.project + '/src/brasil/gov/tema/browser/viewlets/templates',
                self.project + '/src/brasil/gov/tema/browser/viewlets/templates/path_bar.pt',
                ...
                self.project + '/src/brasil/gov/tema/tests/test_viewlets.py',
                ...
                self.project + '/src/brasil/gov/tema/upgrades/v1010',
                self.project + '/src/brasil/gov/tema/upgrades/v1010/__init__.py',
                self.project + '/src/brasil/gov/tema/upgrades/v1010/configure.zcml',
